...
public class FrmSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/unesp.jpg"))); // NOI18N

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("Projeto desenvolvido para a disciplina de Linguagens \nComerciais de Programação, da UNESP DE RIO CLARO,\ndesenvolvido com a orientação do Prof. Me. Alessandro \nViola Pizzoleto.\n\nAutores: Wesley Otto\n\t Guilherme Cabrini\n");
